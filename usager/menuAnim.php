  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Gestion des usager <span class="caret"></span></a>
       
        <ul class="dropdown-menu">
          <li><a href="aform.php">Ajouter un usager</a></li>
          <li><a href="mform.php">Modifier un usager</a></li>
          <li><a href="sform.php">Supprimer un usager </a></li>
